...
#if defined(LVGL_BUFFERS_IN_PSRAM)
static __NOINIT(PSRAM) uint8_t s_frameBuffer[2][LCD_VIRTUAL_BUF_SIZE * DEMO_BUFFER_BYTE_PER_PIXEL];
#else
static uint8_t s_frameBuffer[2][LCD_VIRTUAL_BUF_SIZE * DEMO_BUFFER_BYTE_PER_PIXEL];
#endif
