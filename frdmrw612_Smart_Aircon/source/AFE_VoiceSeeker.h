                             ...
                             uint16_t NumberOfChannel, uint16_t AFE_VoiceSeekerEnable)
{
    ...
    */
    ...
    AFE_VoiceSeekerConfig->vsl_config.mic_xyz_mm = (rdsp_xyz_t*)pvPortMalloc(sizeof(rdsp_xyz_t) * AFE_VoiceSeekerConfig->vsl_config.num_mics);
    if (AFE_VoiceSeekerConfig->vsl_config.mic_xyz_mm == NULL) {
        return AFE_VOICESEEKER_ERROR;
    }

#if MIC_4CH_CONFIG
    /* Ext. DMIC board 4MicA config distance */
    // mic ch0 xyz (MIC0 8CH-DMIC board)
    if (AFE_VoiceSeekerConfig->vsl_config.num_mics > 0) {
        AFE_VoiceSeekerConfig->vsl_config.mic_xyz_mm[0][0] = -35.0f;
        AFE_VoiceSeekerConfig->vsl_config.mic_xyz_mm[0][1] = 0.0f;
        AFE_VoiceSeekerConfig->vsl_config.mic_xyz_mm[0][2] = 0.0f;
    }
    // mic ch1 xyz (MIC2 8CH-DMIC board)
    if (AFE_VoiceSeekerConfig->vsl_config.num_mics > 1) {
        AFE_VoiceSeekerConfig->vsl_config.mic_xyz_mm[1][0] = 17.5f;
        AFE_VoiceSeekerConfig->vsl_config.mic_xyz_mm[1][1] = -30.31f;
        AFE_VoiceSeekerConfig->vsl_config.mic_xyz_mm[1][2] = 0.0f;
    }
#else
    /* On-board 2 mic distance of RD-RW61X IPA-2A/V2 */
    // mic ch0 xyz
    if (AFE_VoiceSeekerConfig->vsl_config.num_mics > 0) {
    ...
    // mic ch1 xyz
    if (AFE_VoiceSeekerConfig->vsl_config.num_mics > 1) {
        AFE_VoiceSeekerConfig->vsl_config.mic_xyz_mm[1][0] = 14.27f;
        AFE_VoiceSeekerConfig->vsl_config.mic_xyz_mm[1][1] = 0.0f;
        AFE_VoiceSeekerConfig->vsl_config.mic_xyz_mm[1][2] = 0.0f;
    }
#endif
    /* Ext. DMIC board 4MicA config distance */
    // mic ch2 xyz (MIC4 8CH-DMIC board)
    if (AFE_VoiceSeekerConfig->vsl_config.num_mics > 2) {
        AFE_VoiceSeekerConfig->vsl_config.mic_xyz_mm[2][0] = 17.5f;
        AFE_VoiceSeekerConfig->vsl_config.mic_xyz_mm[2][1] = 30.31f;
        AFE_VoiceSeekerConfig->vsl_config.mic_xyz_mm[2][2] = 0.0f;
    }
    // mic ch3 xyz (MIC6 8CH-DMIC board)
    if (AFE_VoiceSeekerConfig->vsl_config.num_mics > 3) {
        AFE_VoiceSeekerConfig->vsl_config.mic_xyz_mm[3][0] = 0.0f;
        AFE_VoiceSeekerConfig->vsl_config.mic_xyz_mm[3][1] = 0.0f;
    ...
    AFE_VoiceSeekerConfig->heap_memory = pvPortMalloc(heap_req_bytes);
    ...
    AFE_VoiceSeekerConfig->mic_in = (float**)pvPortMalloc(sizeof(float*) * AFE_VoiceSeekerConfig->vsl_config.num_mics);
